...
<html lang="fr" dir="ltr">
  <head>
    ...
    <?php setcookie('id_account', $_SESSION['id_account'], time() + 3600); ?>
    <style>
      .navbar{
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex">
              <div class="input-group">
                ...
                <button class="btn btn-light" type="submit"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Search_Noun_project_15028.svg/785px-Search_Noun_project_15028.svg.png" width='24' height='24' alt="search_logo"></button>
              </div>
            </form>
          </div>
        </div>
